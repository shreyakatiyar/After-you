  ...
  const services = [
    {
      id: 1,
      title: "Trips & Travels",
      description: "Book tickets for your favourite place",
    ...
    },
    {
      ...
      description: "We offer a range of therapy services to help you cope with stress, anxiety, and emotional issues.",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiJvm4RTeU0PMYlgZkdfEYv3MKuvlDDd_ppQ&s",
    },
    {
      id: 4,
      title: "your cravings",
      description: "We offer a wide range of healthy and delicious food options to satisfy your cravings and maintain a balanced diet.",
